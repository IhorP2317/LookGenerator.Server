...
namespace LookGenerator.Persistence.Data.Migrations
{
    ...
    [Migration("20250430132543_RemovingRedundantUserConfiguration")]
    partial class RemovingRedundantUserConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LookGenerator.Domain.Entities.Look", b =>
                {
                    ...
                    b.HasOne("LookGenerator.Domain.Entities.User", null)
                        .WithMany("Looks")
